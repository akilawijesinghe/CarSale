...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        String[] afterLog = {"logout.xhtml", "detail.xhtml", "default.xhtml", "search.xhtml", "add.xhtml", "searchList.xhtml", "listSearch.xhtml", "detail.xhtml", "brandNewSearchList.xhtml", "usedSearchList.xhtml"};
